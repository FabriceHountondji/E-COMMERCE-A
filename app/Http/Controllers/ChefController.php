...
class ChefController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard/chef/index', compact('title','users'));
    }
    ...
    public function create()
    {
        ...
        $roles = Role::where('name', 'admin')
                        ->orWhere('name', 'chef')->get();
        return view('dashboard/chef/create', compact('title', 'roles'));
    }
    ...
    public function show(User $user)
    {
        ...
        return view('dashboard/chef/show', compact('title', 'users'));
    }
